    ...
    private void buildTestNodes(ExtentTest extenttest,IResultMap tests, Status status) {
        ...
        if (tests.size() > 0) {
            ...
            for (ITestResult result : treeSet) {
                ...
                if(name.contains("caseName")&&name.contains("url=")) {
                	String url=name.substring(name.indexOf("url=")+4,name.indexOf(",action"));
                	name=name.substring(name.indexOf("caseName=")+9,name.indexOf(",stepModels"));
                	name="API:"+name+":"+url;
                }
                if(name.contains("caseName")&&name.contains("Element=")) {
                	name="UI:"+name.substring(name.indexOf("caseName=")+9,name.indexOf(", stepModels"));
                }
                if(name.length()>0){
                    if(name.length()>100){
